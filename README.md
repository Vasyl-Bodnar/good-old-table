...
Utilizes SSE2 if supported, otherwise 64bit SWAR (SIMD Within A Register) which is still leagues faster than going byte by byte.

Base version allows you to provide your own allocated memory for creation or even resizing.
...
You can see an extended example in `src/main.c`
